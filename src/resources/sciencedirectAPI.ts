...
export async function testScienceDirectAPI(){
    ...
    const scopus_citation_overview = "https://api.elsevier.com/content/abstract/citations?doi=10.1186/1471-2105-12-332&apiKey=7f59af901d2d86f78a1fd60c1bf9426a&httpAccept=application%2Fjson"//"https://api.elsevier.com/content/abstract/citations?doi=10.1016/S0014-5793(01)03313-0"//"https://dev.elsevier.com/documentation/AbstractCitationAPI.wadl#d1e25"
    const citations_url = "https://api.elsevier.com/content/search/scopus?query=refeid(' + str(article['eid']) + ')'"
